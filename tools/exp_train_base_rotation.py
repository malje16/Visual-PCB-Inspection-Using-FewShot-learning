...
def My_train_aug(cfg):
    ...
    augs = [T.ResizeShortestEdge(2000, 2400, 'range'),
    T.RandomExtent(scale_range=[0.4, 0.7], shift_range=[0.8, 0.8]),
    T.RandomRotation(angle=[0, 90], sample_style="choice"),
...
def register_my_datasets():
    ...
    register_and_load('merged_all', "/home/maltenj/datasets/fics_pcb_merged/annotations/all.json", "/home/maltenj/datasets/fics_pcb_merged/images")
